...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Plot spurious eigenvalue magnitude results vs L"
    )
    parser.add_argument(
        'csv_path',
        type=str,
    ...
    # Generate plots
    plot_cdf(df, output_dir / "spurious_eigs_L_cdf.png")
    plot_pdf(df, output_dir / "spurious_eigs_L_pdf.png")
